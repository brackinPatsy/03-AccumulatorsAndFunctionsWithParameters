...
def run_test_sum_of_digits():
    ...
    # Test 3
    expected = 3
    answer = sum_of_digits(-101010)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
    #Test 4
    expected = 0
    answer = sum_of_digits(000000)
...
def run_test_digits_in_cube():
    ...
    print('-----------------------------------------------------')
    #test #1 trying a negative number
    expected = 8
    ...
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)
    #test #3 trying a positive number 10
    expected = 1
...
def run_test_fancy_sums_of_digits():
    ...
    # -------------------------------------------------------------------------
   # test 1 - using 10, answer is 1 - I am stupid
    expected = 1
    answer = fancy_sums_of_digits(10)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
    # test 2 - using 2, answer is 19084
    expected = 19084
    answer = fancy_sums_of_digits(2)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)
    # test 3 - using 35, answer is124309
    expected = 124309
